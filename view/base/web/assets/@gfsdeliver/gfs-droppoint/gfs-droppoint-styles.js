const GfsDropPointStyle=document.createElement("template");GfsDropPointStyle.innerHTML=`<dom-module id="gfs-droppoint-styles">
    <template>
        <style>
            :host {
...
</dom-module>`;document.head.appendChild(GfsDropPointStyle.content);